...
re-export-as-default-of-unnamed-class - unnamed export default class {}
re-export-default-export-with-same-name
re-export-without-statements - import *as FP from 'pkg'; export { FP };
...
7. namespaced-import - import* as pkg from 'pkg' used in class declarations (external package)
